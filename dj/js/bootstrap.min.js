 ...
 */
	jQuery('#accordion .panel-title, #accordion2 .panel-title').click(function(e) { 
		jQuery('#accordion .panel-title, #accordion2 .panel-title').removeClass('active');
	...
	jQuery('#accordion .panel-title a').click(function(e) { 
		...
		jQuery(this).parent().find('span i').addClass('fa-minus');
	});
	
	//for accordian2 up and down arrow
	jQuery('#accordion2 .panel-title a').click(function(e) { 
		jQuery('#accordion2 .panel-title i.pull-right').removeClass('fa-angle-up');
		jQuery('#accordion2 .panel-title i.pull-right').addClass('fa-angle-down');
		jQuery(this).parent().find('i.fa-angle-down').addClass('fa-angle-up');
		jQuery(this).parent().find('i.fa-angle-down').removeClass('fa-angle-down');
	});
